...
# virtualenv is setup up in the directory above our vboxfs mount of the
# moniker repo on the host as the virtualenv environment relies on symlinks
# which don't work on vboxfs mounts
